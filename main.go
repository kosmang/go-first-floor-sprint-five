...
func (w Walking) Calories() float64 {
	...
	calWeight := CaloriesWeightMultiplier * w.Weight
	calHeight := CaloriesSpeedHeightMultiplier * w.Weight
	return ((calWeight + speed*calHeight) * w.Duration.Hours() * MinInHours)
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	return (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesMeanSpeedShift * s.Weight * s.Duration.Hours()
}
